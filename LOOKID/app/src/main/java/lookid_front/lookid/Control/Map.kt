...
class Map(var mapView: MapView?, var childlist: ArrayList<Child_Entity>, context: Context?): MapView(context), MapView.CurrentLocationEventListener {
    var myX : Double ?= null
    var myY : Double ?= null
    ...
    fun set_childlist(childlist: ArrayList<Child_Entity>){
    ...
    fun set_Marker(){
        ...
        for (i in 0..childlist.size - 1) {
            ...
            marker.itemName = childlist!![i].name
